...
- **Valdirone Nuova** — 1,375.13 m, 8 corners, 12.55 m of elevation, 44.82 s.
  Designed, verified, awaiting approval. Not built.
...
- **Grid slot spacing is unsourced.** CIK-FIA Appendices 9, 10 and 15 are
  referenced by the Part 1 text and are not public. ADR-0046 needs the figure.
